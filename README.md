...
### This repo hosts the code for course project done during Winter 2020 semester 
Instructions: A demo notebook for static method 1 and static method 2 is present within dyna_exps/.

The failed experiment can be seen inside dyna_exps/training.py 
